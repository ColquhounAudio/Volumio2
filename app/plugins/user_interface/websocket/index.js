...
function InterfaceWebUI(context) {
	...
	self.libSocketIO.on('connection', function (connWebSocket) {
		...
		connWebSocket.on('enableAirplay1', function () {
			var selfConnWebSocket = this;
			self.logger.info("Command EnableAirplay1 Received");
			self.commandRouter.executeOnPlugin('system_controller', 'system', 'enableAirplay1', '');

		});
		connWebSocket.on('enableAirplay2', function () {
			var selfConnWebSocket = this;
			self.logger.info("Command EnableAirplay2 Received");
			self.commandRouter.executeOnPlugin('system_controller', 'system', 'enableAirplay2', '');

		});
		connWebSocket.on('enableSupport', function () {
			var selfConnWebSocket = this;
			self.logger.info("Command enableSupport Received");
			self.commandRouter.executeOnPlugin('system_controller', 'system', 'enableSupport', '');
