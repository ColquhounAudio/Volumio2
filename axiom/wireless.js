...
var starthostapd = "systemctl start wac.service";
var stophostapd = "systemctl stop wac.service";
...
//20180530 configuration changed by Emre Ozkan 
// direct hotspot value changed to false. (It was true)
	...
	//20180530-Emre Ozkan- if statement deleted 	
            ...
            //20180530 Emre Ozkan  code removed here to force the hotspot mode if there is no wifi is connected.Original code is in google drive
...
if (process.argv.length < 2) {
    ...
    switch (args) {
        case "start":
            case "start":
		//20180608-Emre Ozkan StopHotspot command deleted in order to avoid to stop wac
